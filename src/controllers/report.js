...
export default class reportController {
  ...
  static async update ( req, res) {
    ...
    try {
      ...
      const newRatio = {
        korean : ratio.korean , math : 0 , englsih : ratio.english, tamgu : 0, history : ratio.history
      }
      ...
      const applicationIndicator = majorData.metadata.applicationIndicator
      const newScore = {
        korean : 0 , english : 0, tamgu : 0 , math : 0 , history : 0 
      }
      ...
      else if ( reflectionSubject.indexOf("탐+국,수,영중 택2") >= 0 ) {


      }
      else if ( reflectionSubject.indexOf("탐+국,수,영중 택1") >= 0) {

      }

      else if ( reflectionSubject.indexOf("국,수,영,탐중 상위 3개 영역") >= 0) {
      ...
      else if ( reflectionSubject.indexOf("영,탐+국,수중 택1") >= 0) {
      ...
      else if ( reflectionSubject.indexOf("국,수,영,탐중 택3") >= 0) {
      ...
      else if ( reflectionSubject.indexOf("국,수,영,탐 중 택3") >= 0) {
      ...
      else if ( reflectionSubject.indexOf("탐+수+국,영중 상위1개영역") >= 0 )  {


      }
      else if ( reflectionSubject.indexOf("국,수,영,탐,제2외국어중 택3") >= 0 ) {
      ...
      const score_sum = newScore.korean + newScore.math + newScore.tamgu + newScore.english
      ...
      const modelObj = {
        ...
        //totalScore : newScore.korean + newScore.math + newScore.english + newScore.tamgu + newScore.history + extraScore.korean + extraScore.math + extraScore.english + extraScore.tamgu + extraScore.history
      }

      const report = await reportService.update(reportId, modelObj)
