...
var University = /*#__PURE__*/function (_Sequelize$Model) {
  _inherits(University, _Sequelize$Model);

  var _super = _createSuper(University);
  ...
  _createClass(University, null, [{
    ...
    value: function init(sequelize) {
      return _get(_getPrototypeOf(University), "init", this).call(this, {
        type: {
